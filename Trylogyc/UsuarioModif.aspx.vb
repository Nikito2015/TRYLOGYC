...
Public Class UsuarioModif
    ...
    Protected Sub btnSavePass_Click(sender As Object, e As EventArgs) Handles btnSavePass.Click
        Try
            ...
            If Session("nomUsuario") Is Nothing Then
                Session("nomUsuario") = Request.Cookies("username").Value
            End If
        ...
        Catch ex As Exception
            lblError.Text = "Ocurrieron Errores durante la actualización de los datos."
            divError.Visible = True
            divSuccess.Visible = False
        End Try
    End Sub
